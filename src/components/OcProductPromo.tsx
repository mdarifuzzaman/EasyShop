...
type OcProductPromoProps = ComponentProps & {
  fields: {
...
const OcProductPromo = (props: OcProductPromoProps): JSX.Element => {
  ...
  useEffect(() => {
    //const total = props.fields.totalPage.value;
...
export default withDatasourceCheck()<OcProductPromoProps>(OcProductPromo);
